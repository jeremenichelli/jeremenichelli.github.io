    ...
    A.prototype.load = function(a, b) {
        ...
        return new Promise(function(a, b) {
            if (J() && !G()) {
                ...
                function I() {
                    if (new Date().getTime() - H >= D) d.parentNode && d.parentNode.removeChild(d), 
                    b(c); else {
...
(function(_win, _doc) {
    "use strict";
    var w400r = new FontFaceObserver("Fira Sans", {
        weight: 400
    }).load();
    var w400i = new FontFaceObserver("Fira Sans", {
        weight: 400,
        style: "italic"
    }).load();
    var w700r = new FontFaceObserver("Fira Sans", {
        weight: 700
    }).load();
